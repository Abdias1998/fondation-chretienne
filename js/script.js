  ...
  subscribeForm.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        text.innerHTML =
          "<div style='   background-color: #f5f5f5;margin:10px'><p style='padding:15px'>Merci beaucoup pour votre inscription. Votre email a été ajouté à notre liste de contacts, mais doit être confirmé. Dans quelques minutes, vous recevrez un email contenant un lien de confirmation. Veuillez répondre à ce mail par « oui ».</p>"(
            "</div>"
          );
